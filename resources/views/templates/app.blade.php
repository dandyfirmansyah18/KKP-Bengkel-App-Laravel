...
<head>
  ...
  <title>Bengkel 99</title>
  <link rel="Shortcut Icon" href="{{ URL::asset('/bengkel.gif') }}" type="image/x-icon" />
...
<script src="{{ URL::asset('/AdminLTE/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js') }}"></script>
<!-- Chart JS -->
<script src="{{ URL::asset('/AdminLTE/bower_components/chartjs/Chart.js') }}"></script>
<!-- DataTables -->
...
<body class="hold-transition skin-blue sidebar-mini" ng-app="project_wreda">
<div class="wrapper">
  @section('header')
  ...
  <div class="content-wrapper" id="_content_">
    {!!$_content_!!}
  </div>
  <!-- /page content -->
