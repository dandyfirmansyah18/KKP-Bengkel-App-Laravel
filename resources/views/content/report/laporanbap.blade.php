...
<body> 
<!-- <h1 colspan="10" align="center" height="40">Laporan {{$type}} Tanggal {{$tanggal}} </h1>  -->
<table >
    <thead>
    <tr>
    ...
    <tr>
        <td colspan="6" align="center">LAPORAN REKAP BERITA ACARA PEKERJAAN (BAP)</td>
    </tr>
    <tr>
...
<table style="border: 1px solid black;">
    ...
    <tr>        
        ...
        <th width="20" align="center"  style="text-align:center;background-color:#ECF542; border: 3px solid #000000;">No BAP</th>
        ...
        <th width="20" align="center"  style="text-align:center;background-color:#ECF542; border: 3px solid #000000;">KM/Odometer</th>
        <th width="35" align="center"  style="text-align:center;background-color:#ECF542; border: 3px solid #000000;">Mekanik</th>
    </tr>

@foreach($data['isi'] as $datas)
    <tr>
        <td style="border: 3px solid #000000;">{{ $datas->no }}</td>
        <td style="border: 3px solid #000000;">{{ $datas->id_bap}}</td>
        <td style="border: 3px solid #000000;">{{ $datas->no_polisi}}</td>
        <td style="border: 3px solid #000000;">{{ $datas->merk_mobil }}</td>
        <td style="border: 3px solid #000000;">{{ number_format($datas->kilometer) }} KM</td>
        <td style="border: 3px solid #000000;">{{ $datas->nm_karyawan }}</td>
    </tr>
@endforeach
