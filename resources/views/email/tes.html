            ...
            valign="top">
                ...
                width="560">
                    ...
                    <tr>
                        <td align="center" class="hero" style="background-color: #716aca;border-collapse: collapse; border-spacing: 0; margin: 0; padding: 10px 0;" valign="top">
                            ...
                            <h2 style="color:#fff;font-family:Helvetica;">Bengkel 99 Password Login</h2>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        valign="top">
                            ...
                            <p style="margin: 30px 0;">
                            Berikut adalah user, password login anda :
                            </p>
                            <p>
                            Username : {{$password}}
                            </p>
                    ...
                    <tr >
                        <td align="center" class="list-item" style="font-family: sans-serif;border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 15px; padding-right: 15px; color: #555555" valign="top">
                            <h4 style="font-weight:bold;">PT. Membetulkan Yang Sudah Rusak</h4>
                                <p style="line-height:120%; font-size:13px">                                
                                Jl. Kelapa Puan Timur II ND 2 / 16<br>
                                Phone: +6221 999 9999 | Fax: +6221 812 9999<br>
                                Email: customerservice@bengkel99.com<br>
                                sales@bengkel99.com</p>
                                </address>
                        </td>
                    </tr>
                    <!-- PARAGRAPH -->
                ...
                width="560">
                    ...
                    <tr>
                        ...
                        valign="top">
                            <img src="http://4.bp.blogspot.com/-OLL-klfrw3M/UzSZGpNvNlI/AAAAAAAABY0/AnMlOljd33U/s1600/Untitled-1.jpg" width="100px">
                        </td>
                    </tr><!-- FOOTER -->
                    <!-- Set text color and font family ("sans-serif" or "Georgia, serif"). Duplicate all text styles in links, including line-height -->
                    <tr>
                        ...
                        valign="top">
                            Copyright © {{date('Y')}}. PT. Membetulkan Yang Sudah Rusak
                        </td>
                    </tr><!-- End of WRAPPER -->
